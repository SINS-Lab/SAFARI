...
C
C  Modification of 20Jan92 by C.A. DiRubio, with 
C  correction of 06Mar92 by C.A. DiRubio, and 
C  modified on 13Aug93 by E.R. Behringer for group use.
C
C
...
c use einstein spring
            ...
            DO 400 I=J+1,NPART
c R0 is the equilibrium spacing
...
C
      IF (INEL) THEN
         DPX=DPX-ALPHA*DENS(Z,Z0)*PX*MION1
         DPY=DPY-ALPHA*DENS(Z,Z0)*PY*MION1
         DPZ=DPZ-ALPHA*DENS(Z,Z0)*PZ*MION1
      ENDIF
      RETURN                                                            
      END                                                               
C                                                                       
...
C**********************************************************************
C
      DOUBLE PRECISION FUNCTION DENS(Z,Z0)
C
