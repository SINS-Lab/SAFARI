...
C
C  ****READ PARAMETERS FOR  INELASTIC LOSSES****
C
       READ(9,*) INEL
       WRITE(10,8338) INEL
8338   FORMAT(1X,'INELASTIC LOSSES = ',L1)
       READ(9,*) ALPHA,Z0
       IF (INEL) THEN
          WRITE(10,8342) ALPHA
          WRITE(10,8343) Z0
       ENDIF
8342   FORMAT(1X,'ALPHA FOR INELASTIC LOSSES = ',f10.5)
8343   FORMAT(1X,'Z0 = ELECTRON DENSITY DECAY LENGTH = ',f10.5)
