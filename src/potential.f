...
C************************************
      ...
      IF(IPOT.EQ.1) THEN
         POTENT='TWO-EXPONENTIAL POTENTIAL'
      ELSE IF(IPOT.EQ.2) THEN
         POTENT='ZIEGLER-BIERSACK-LITTMARK POTENTIAL'
      ELSE IF(IPOT.EQ.3) THEN
         POTENT='EXPONENTIAL+GAUSSIAN POTENTIAL'
      ENDIF
      IF(IIMPOT.EQ.1) THEN
         POTENT=POTENT//' WITH FLAT IMAGE'
      ELSE IF(IIMPOT.EQ.2) THEN
         POTENT=POTENT//' WITH CORRUGATED IMAGE'
      ENDIF
      RETURN
      END
C***********************************************************************
