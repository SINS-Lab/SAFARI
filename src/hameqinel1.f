...
C
      ...
      Z0=0.3
C  
C   ZO IS THE RATE OF DECAY OF THE ELECTRON DENSITY BEYOND THE
C   JELLIUM EDGE, WHICH IS AT 1.805 ANGSTROMS FOR CU. THE 
C   EXPONENTIAL FALL OFF IS AN APPROXIMATION.
C   Z0=0.3 APPROXIMATELY. THE VALUE USED ABOVE MAY BE DIFFERENT.
C
      IF (Z.LE.1.55) THEN
	  DENS=8.47D-2
      ELSE
